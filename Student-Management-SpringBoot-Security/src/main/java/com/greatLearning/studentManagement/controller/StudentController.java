...
public class StudentController {
	...
	public String delete(@RequestParam("studentId") int theId) {
	  ...
	  @RequestMapping(value = "/403") public ModelAndView accesssDenied(Principal
	  user) {
	  
	  ModelAndView model = new ModelAndView();
	  
	  if (user != null) { model.addObject("msg", "Hi " + user.getName() +
	  ", attempted to access this page!");
	  
	  } else { model.addObject("msg",
